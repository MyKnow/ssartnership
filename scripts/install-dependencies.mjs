...
const platformPackages = {
  "darwin-arm64": ["@esbuild/darwin-arm64", "bin/esbuild", "e2dc9a52440a2a34f09434a2f4843cb1e30f84e40dcf238976ec61ef8cd7f36a"],
  "darwin-x64": ["@esbuild/darwin-x64", "bin/esbuild", "dd53ccf32f9b5b3ab30d41388ef1fc8f81c44ca57ee7a32a7364a1753308d009"],
  "linux-arm64": ["@esbuild/linux-arm64", "bin/esbuild", "51e829ba36f36be6d9aea6e329ddc4f9350302339b16aaca96a3cb97f64a8ebb"],
  "linux-x64": ["@esbuild/linux-x64", "bin/esbuild", "0c6588b092a2c291a72bab90659f3c9e0e25e0fe59c9ac12b4dae4d945e5548c"],
};
...
process.stdout.write("[install-scripts] Trusted dependency installation completed with zero lifecycle scripts.\n");
