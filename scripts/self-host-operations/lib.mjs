...
const MANAGED_ENVIRONMENT = /^(?:COMPOSE_|POSTGRES_|JWT_|SUPABASE_|SELF_HOST_|PGBACKREST_|RESTIC_|OFFHOST_|PGRST_|STORAGE_|KONG_|PGPASSWORD$|PGDATABASE$|PGPORT$)/u;
