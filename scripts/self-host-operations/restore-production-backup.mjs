...
try{
 ...
 check(manifest.version===1&&manifest.kind==='production-cold-snapshot'&&manifest.databaseCleanlyStopped===true&&manifest.applicationWritesQuiesced===true&&manifest.databaseSystemId==='7683514695522750473');
