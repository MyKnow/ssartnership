  ...
  switch (input.action) {
    case "partner_company_create":
      return {
        ...
        tone: "success",
        badgeLabel: "파트너사",
        title: `${input.companyName} 파트너사가 등록되었습니다`,
        body: summaryText ?? "파트너사 정보가 새로 등록되었습니다.",
    ...
    case "partner_company_update":
      return {
        ...
        tone: "primary",
        badgeLabel: "파트너사",
        title: `${input.companyName} 파트너사 정보가 수정되었습니다`,
        body: summaryText ?? "파트너사 정보가 수정되었습니다.",
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
    ...
    case "partner_company_delete":
      return {
        ...
        tone: "danger",
        badgeLabel: "파트너사",
        title: `${input.companyName} 파트너사가 삭제되었습니다`,
        body: summaryText ?? "파트너사 정보가 삭제되었습니다.",
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
    ...
    case "partner_create":
      return {
        ...
        tone: "success",
        badgeLabel: "제휴처",
        title: `${input.partnerName ?? "제휴처"}가 등록되었습니다`,
        body:
          summaryText ??
          (input.companyName ? `${input.companyName} 소속 제휴처가 새로 등록되었습니다.` : "제휴처 정보가 새로 등록되었습니다."),
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
    ...
    case "partner_update":
      return {
        ...
        tone: "primary",
        badgeLabel: "제휴처",
        title: `${input.partnerName ?? "제휴처"} 정보가 수정되었습니다`,
        body: summaryText ?? "제휴처 정보가 수정되었습니다.",
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
    ...
    case "partner_review_hide":
      return {
        ...
        tone: "warning",
        badgeLabel: "리뷰",
        title: `${input.partnerName ?? "제휴처"} 리뷰가 숨김 처리되었습니다`,
    ...
    case "partner_review_restore":
      return {
        ...
        tone: "success",
        badgeLabel: "리뷰",
        title: `${input.partnerName ?? "제휴처"} 리뷰 숨김이 해제되었습니다`,
    ...
    case "partner_review_update":
      return {
        ...
        tone: "primary",
        badgeLabel: "리뷰",
        title: `${input.partnerName ?? "제휴처"} 리뷰가 수정되었습니다`,
    ...
    case "partner_review_delete":
      return {
        ...
        tone: "danger",
        badgeLabel: "리뷰",
        title: `${input.partnerName ?? "제휴처"} 리뷰가 삭제되었습니다`,
    ...
    case "partner_account_create":
      return {
        ...
        tone: "success",
        badgeLabel: "계정",
        title: "파트너사 계정이 생성되었습니다",
        body: summaryText ?? "파트너사 계정이 새로 만들어졌습니다.",
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
    ...
    case "partner_account_company_update":
      return {
        ...
        tone: "warning",
        badgeLabel: "권한",
        title: "파트너사 접근 권한이 변경되었습니다",
        body: summaryText ?? "연결된 파트너사 권한이 변경되었습니다.",
        companyId: input.companyId,
        companyName: input.companyName,
        partnerId: input.partnerId,
        partnerName: input.partnerName,
