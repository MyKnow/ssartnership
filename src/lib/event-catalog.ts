export const PRODUCT_EVENT_NAMES = [
  ...
  'partner_benefit_use_pin_attempt',
  'partner_benefit_use_success',
  'partner_benefit_use_failure',
  'partner_benefit_use',
  'share_link_copy',
  'push_settings_view',
  'push_subscribe',
...
export const ADMIN_AUDIT_ACTIONS = [
  ...
  'partner_benefit_usage_create',
  'partner_benefit_usage_update',
  'partner_benefit_usage_delete',
