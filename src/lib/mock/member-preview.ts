...
export const mockPreviewMembers: MockPreviewMember[] = [
  ...
  {
    id: "mock-student-16",
    mm_user_id: "mm-student-16",
    mm_username: "seoha.park16",
    display_name: "박서하16",
    year: 16,
    campus: "서울",
    must_change_password: false,
    service_policy_version: 2,
    service_policy_consented_at: "2026-07-08T01:20:00.000Z",
    privacy_policy_version: 2,
    privacy_policy_consented_at: "2026-07-08T01:20:00.000Z",
    marketing_policy_version: 1,
    marketing_policy_consented_at: "2026-07-08T02:00:00.000Z",
    notification_preferences: {
      enabled: true,
      announcementEnabled: true,
      newPartnerEnabled: true,
    ...
    updated_at: "2026-07-08T02:20:00.000Z",
  },
  {
    id: "mock-student-14",
