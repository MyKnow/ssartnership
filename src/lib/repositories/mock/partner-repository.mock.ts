...
const partners: Partner[] = [
  ...
  },
  {
    ...
    detailDescription:
      "역삼역 3번 출구에서 도보 4분 거리에 있는 SSAFY 구성원 전용 제휴 카페입니다. 넉넉한 테이블과 콘센트 좌석을 갖춰 수업 전후의 짧은 휴식과 팀 스터디에 잘 어울립니다.",
    campusSlugs: ["seoul"],
    mapUrl: "https://map.naver.com/",
    benefitActionType: "certification",
    ...
    images: [
      "/mock/partners/cafe-ssafy/exterior.png",
      "/mock/partners/cafe-ssafy/interior.png",
      "/mock/partners/cafe-ssafy/coffee.png",
    ],
    tags: ["역삼역 도보 4분", "콘센트 좌석", "팀 스터디"],
  },
  {
    id: "space-001",
    name: "협업 스테이션",
