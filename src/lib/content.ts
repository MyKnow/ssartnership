import { SITE_LEGACY_NAME, SITE_NAME, SSAFY_FULL_NAME, SSAFY_SHORT_KOR_NAME, SSAFY_SHORT_NAME } from "@/lib/site";
...
export const HOME_COPY = {
  ...
  categoryDescription: `원하는 카테고리를 선택해 ${SSAFY_SHORT_KOR_NAME} 제휴 혜택을 찾아보세요.`,
