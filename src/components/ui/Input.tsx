...
>(function Input({ className, ...props }, ref) {
  return (
    <input
      ...
      {...props}
      className={cn(
        "h-11 w-full rounded-[1rem] border border-border bg-surface/90 px-3.5 text-sm text-foreground shadow-[var(--shadow-flat)] transition-[border-color,background-color,box-shadow] duration-200 ease-out placeholder:text-muted-foreground",
