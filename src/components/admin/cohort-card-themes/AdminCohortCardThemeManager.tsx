...
export function AdminCohortCardThemeManager({
  ...
  return (
    <Card id="card-theme-manager" tone="elevated" className="grid gap-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <SectionHeading
          title="기수별 카드 색상"
          description="기수별 인증 카드 색상은 DB에 저장됩니다. 배경 3색과 강조색만 저장하고, 글자 대비는 카드 렌더러가 자동 보정합니다."
        />
...
export function AdminCertificationCardPreviewGrid({
  ...
  return (
    <Card id="card-preview" tone="elevated" className="grid gap-5">
      <SectionHeading
        title="인증 카드 목업"
        description="기수별 색상과 수료생 대비를 실제 카드 컴포넌트로 확인합니다."
      />
