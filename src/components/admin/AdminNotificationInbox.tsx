...
export default function AdminNotificationInbox({
  ...
  async function markAsRead(item: AdminNotificationInboxItem) {
  ...
  async function markAsReadAndOpen(item: AdminNotificationInboxItem) {
  ...
  async function deleteNotification(item: AdminNotificationInboxItem) {
    if (pendingId || pendingAction) {
      return;
    }
