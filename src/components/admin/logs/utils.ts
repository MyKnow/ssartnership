...
const productLabels: Record<string, string> = {
  ...
  suggest_submit: '제휴처 제안 제출',
  pwa_install_click: 'PWA 설치 클릭',
  certification_view: '내 인증 조회',
...
const auditLabels: Record<string, string> = {
  ...
  partner_company_create: '파트너사 생성',
  partner_company_update: '파트너사 수정',
  ...
  partner_change_request_reject: '제휴처 변경 요청 거절',
  member_update: '회원 수정',
  ...
  partner_account_update: '파트너사 포털 계정 수정',
  partner_account_create: '파트너사 포털 계정 추가',
  partner_account_company_update: '파트너사 포털 연결 수정',
  partner_account_initial_setup_link_generate: '파트너사 포털 초기설정 URL 생성',
  partner_account_initial_setup_link_send: '파트너사 포털 초기설정 URL 전송',
  partner_company_plan_update: '제휴처 플랜 변경',
  partner_plan_upgrade_approved: '제휴처 플랜 업그레이드 승인',
  partner_plan_upgrade_rejected: '제휴처 플랜 업그레이드 반려',
  partner_portal_immediate_update: '파트너사 포털 즉시 수정',
  partner_portal_change_request_submit: '파트너사 포털 변경 요청 제출',
  partner_portal_change_request_cancel: '파트너사 포털 변경 요청 취소',
  partner_portal_review_hide: '파트너사 포털 리뷰 숨김',
  partner_portal_review_restore: '파트너사 포털 리뷰 복구',
...
const securityLabels: Record<string, string> = {
  ...
  member_mattermost_code: 'Mattermost DM 코드 인증',
  member_email_verification: '회원 이메일 인증',
  ...
  partner_login: '파트너사 포털 로그인',
  partner_logout: '파트너사 포털 로그아웃',
  partner_initial_setup: '파트너사 포털 초기 설정',
  partner_password_reset: '파트너사 포털 비밀번호 재설정',
  partner_password_change: '파트너사 포털 비밀번호 변경',
};
