---
title: SSAFY Verify External API Delegation Plan
type: history
status: superseded
authority: evidence
superseded_by: ../../decisions/ADR-0001-direct-mattermost-integration.md
---

# SSAFY Verify External API Delegation Plan

> Superseded: 2026-07-17에 Verify runtime을 제거하고 직접 Mattermost 연동으로 전환했다. 현재 결정은 [ADR-0001 Mattermost 직접 연동](../../decisions/ADR-0001-direct-mattermost-integration.md)이다. 이 문서는 당시 대안과 전환 맥락만 보존한다.
