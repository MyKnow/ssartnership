---
title: DB Schema-Service Refactor
type: exec-plan
status: completed
authority: evidence
---
...
- `wave-11-planning`: moved to [기술 부채 추적기](../tech-debt.md)
...
- `partner_accounts.initial_setup_verification_code_hash`
  - Schema presence: [schema.sql](../../../supabase/schema.sql)
  - Code usage: written as `null`, never read for validation
  - Evidence:
    - [setup.ts](../../../src/lib/partner-auth/setup.ts)
    - [setup-link.ts](../../../src/app/admin/(protected)/_actions/partner-support/setup-link.ts)
    - [account-actions.account.ts](../../../src/app/admin/(protected)/_actions/account-actions.account.ts)
...
- Admin members page still selected `avatar_base64` for every row even though the UI can load avatars via `/api/admin/members/[id]/avatar`.
  - Query: [members/page.tsx](../../../src/app/admin/(protected)/members/page.tsx)
  - Consumer: [AdminMemberListItem.tsx](../../../src/components/admin/AdminMemberListItem.tsx)
