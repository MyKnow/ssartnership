...
작성 기준일: 2026-07-23
관련 Issue: #205
기준 명세: [관리자 기능·UI/UX 구현 명세](../../specs/205-admin-console/spec.md)
...
- 변경 후보: `docs/specs/205-admin-console/spec.md`, 이 문서, `docs/product/screen-specs/*`, scenario coverage metadata.
- 수용 기준:
