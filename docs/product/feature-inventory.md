...
최종 교정일: 2026-07-17. 사용자 용어는 [제품 용어](./glossary.md)를 따르며, 유지·통합·제거 판정은 [기능 점수표](./feature-scoring.md)를 따른다.
...
| Apple Wallet 회원 패스 | `/api/wallet/apple/pass`, `/api/wallet/apple/v1/**`, `/wallet/verify/[token]` | [MVP 제품 계약](../specs/301-apple-wallet-member-pass/spec.md), `.pkpass` 발급/폐기, 공개 실시간 검증, Apple device registration/APNs 갱신 |
