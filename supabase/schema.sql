...
set is_active = false,
    updated_at = now()
where kind in ('service', 'privacy', 'marketing')
  and is_active = true;
...
- 이메일: myknow00@naver.com$$,
  ...
  (
    ...
    2,
    '마케팅 정보 수신 동의',
    '제휴 혜택, 이벤트, 캠페인 등 선택적 안내 수신 기준을 안내합니다.',
    $$## 1. 목적
싸트너십은 이용자가 동의한 경우 제휴 혜택, 이벤트, 캠페인, 프로모션, 설문, 서비스 활용 안내 등 선택적 정보를 전송할 수 있습니다.

## 2. 수신 항목
- 신규 또는 추천 제휴 혜택
- 이벤트 및 캠페인 안내
- 혜택 활용 팁과 서비스 소식
- SSAFY 구성원 대상 제휴 프로모션

## 3. 수신 채널
마케팅성 안내는 이용자의 설정 상태에 따라 인 앱 알림, 푸시 알림, Mattermost 알림 등으로 제공될 수 있습니다.

## 4. 동의 및 철회
본 동의는 선택 사항이며, 동의하지 않아도 기본 서비스 이용에는 제한이 없습니다. 이용자는 언제든지 알림 설정에서 마케팅/이벤트 수신 여부를 변경할 수 있습니다.

## 5. 보유 및 이용 기간
마케팅 수신 동의 상태와 동의 이력은 동의 철회 또는 회원 탈퇴 시까지 보관할 수 있으며, 분쟁 대응과 동의 이력 확인이 필요한 경우 필요한 범위에서 보관될 수 있습니다.
