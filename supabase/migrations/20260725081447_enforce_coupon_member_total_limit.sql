-- Enforce the member-wide coupon usage limit on the wallet RPC path.
-- The active issue check prevents duplicate holdings; this count prevents
-- downloading and redeeming a new issue after the configured total is spent.
