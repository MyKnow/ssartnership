...
- A bug reproduced on Preview becomes planned work as soon as its root cause needs a migration, schema snapshot, or shared validation contract; create the Issue at that point, before writing the fix.
