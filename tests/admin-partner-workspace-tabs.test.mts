...
test("admin partner workspace exposes separate tabs for partners, requests, plans, and categories", async () => {
...
test("admin partner workspace tab normalization accepts current and legacy values", async () => {
  ...
  assert.equal(normalizeAdminPartnerWorkspaceTab("plans"), "plans");
