...
- The project `prepush` script is the required local Public Readiness gate and runs `CI=1 PLAYWRIGHT_CHROMIUM_CHANNEL=chrome playwright test`. The ECC global pre-push hook executes this optional repository gate after lint/test/build.
