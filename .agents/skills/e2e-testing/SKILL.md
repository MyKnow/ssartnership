...
- For geometry that settles after responsive hydration, poll the exact alignment predicate on the same page instead of accepting a wider tolerance or relying on a whole-test retry.
...
- When adding image/crop/review flows, verify Storybook interaction tests as well as E2E; story assertions often catch copy and media error-state contract drift before CI.
